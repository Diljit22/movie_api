...
def test_cache_stats_recording():
    ...
    stats = CacheStats()
    stats.record_l1_hit()
    stats.record_l1_miss(); stats.record_l1_miss()
    stats.record_l2_hit()
...
def test_cache_stats_hit_rate_calculation():
    ...
    stats.record_l1_miss(); stats.record_l1_miss(); stats.record_l1_miss()
    stats.record_l2_hit(); stats.record_l2_hit() # 2 hits, 1 miss -> 66.67% L2
    stats.record_l2_miss()
...
def test_cache_stats_to_dict():
    ...
    stats = CacheStats()
    stats.record_l1_hit(); stats.record_l1_miss()
    data = stats.to_dict()
...
def test_cache_stats_reset():
    ...
    stats = CacheStats()
    stats.record_api_call(); stats.record_l1_hit()
    stats.reset()
